...
internal static class GeneratedLearningRuntimeContractValidator
{
    ...
    [
        ...
        ("question-count-default", "count:this.props.questionCount??30"),
        ("question-count-range", "sourceSettings.count,def.count)),10,50)"),
        ("pass-line-default", "pass:this.props.passLine??23"),
        ("addition-generator", "genAdd(p)"),
        ("written-arithmetic-generator", "genHissan(p)"),
        ("interactive-written-arithmetic-plan", "writtenArithmeticPlan(q)"),
        ("interactive-written-arithmetic-controller", "submitWrittenStep(val)"),
        ("interactive-written-arithmetic-mode", "modeWrittenSteps"),
        ("interactive-written-arithmetic-checkpoint", "waStep:Number(S.waStep)||0"),
        ("numeric-keyboard-listener", "this._mathKeyHandler"),
        ...
        ("kanji-drill-learned-words", "drillKanjiWords(grade)"),
        ...
        ("adaptive-session-support", "Number(s.supportTopics[id])"),
        ...
        ("learning-schema", "p.learningSchema=7"),
        ("stage-attempts", "stageAttempts"),
        ("bounded-stage", "Math.min(5,Number(stage)||1)"),
        ("mastery-achievement", "masteredAt"),
        ("multiplication-fact-curriculum", "multiplicationStageFactKeys(stage)"),
        ("multiplication-fact-evidence", "recordMultiplicationFact(s,q,outcome,now)"),
        ("multiplication-memory-input", "memoryAssessment:true"),
