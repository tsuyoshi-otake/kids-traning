...
internal static class GeneratedLearningRuntimeContractValidator
{
    ...
    [
        ...
        ("question-grade-snapshot", "q.grade=this.effectiveGrade(sp)"),
        ("question-grade-label", "学年：{{ questionGradeLabel }}"),
        ("question-category-label", "カテゴリ：{{ questionCategoryLabel }}"),
        ("question-difficulty-label", "難易度：{{ questionDifficultyLabel }}"),
        ("calibration-grade-label", "学年：{{ calibGradeLabel }}"),
        ...
        ("learning-schema", "learningSchema===4"),
