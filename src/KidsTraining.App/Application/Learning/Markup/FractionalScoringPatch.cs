...
freshQ(){this.clearAutoAdvance();this._terminalQuestionToken='';this._answerBusy=false;return {hsStep:0,hsOnes:'',hsTens:'',hsCarry:false,hsBorrow:false,hsMistakes:0,hsHint:'',input:'',numMiss:0,numChoices:null,hsStepMiss:0,hsStepChoices:null,typed:'',typeMiss:0,choiceMiss:0,attemptNotice:''};}
""";
