...
internal static partial class CurriculumPolicy
{
    ...
    private static void AddUpperMathematics(Action<string, string, int, string, string, string, CurriculumQuestion[]> add)
    {
        ...
        [
            ...
            Q(2, "1個120円の品を□個買う代金を表す式は？", "120×□", ["120+□", "□÷120", "120-□"], "1個分×個数で全体の代金になる。"),
            Q(2, "1本80円のえんぴつを□本買う代金を表す式は？", "80×□", ["80+□", "□÷80", "80-□"], "1本分×本数で全体の代金になる。"),
            Q(2, "1人に△個ずつ配るとき、5人分の個数を表す式は？", "△×5", ["△+5", "5÷△", "△-5"], "1人分×人数で全体の個数になる。"),
