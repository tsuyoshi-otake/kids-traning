...
- The start screen also offers とっくんモード as four cards beside the mission and weakness cards, each starting a fixed 200-question course: grade-1 addition/subtraction, grade-2 multiplication tables, grade-1 kanji reading, and grade-2 kanji reading. The grade-1 arithmetic course starts at `1 ＋ 1` and drills the complements of ten and subtraction from ten repeatedly, in both direct and missing-number form; the grade-2 course covers all 81 ordered facts plus commutativity and missing-factor questions. The kanji courses take their words and readings from the same canonical MEXT bank (80 and 160 characters) and are answered by choosing one of four readings, the other three being readings of other kanji of the same grade. A first mistake shows a hint and allows a retry, a second reveals the answer and requeues that question at the end of the course, and only first-try answers count as clean. Progress is kept per course under `kt_drill_v1`, resumes where it stopped, and can be reset per course with a two-tap confirmation. The drill never writes mastery, stage, XP, or star evidence, so extra practice cannot inflate curriculum progress.
