...
- An English topic えいご (eigo) matches the MEXT grade 3-4 foreign language activities: colors and numbers 1-10 both directions (English→Japanese and Japanese→English), everyday words (animals, food, school items) at stage 2+, and greetings/basic phrases (Hello, Good morning, Thank you, What is your name?) at stage 3+. It unlocks at effective grade 3+ after もじ is cleared, complementing the alphabet/romaji coverage in moji.
- Written arithmetic (hissan) extends at its top stage to 3-digit addition/subtraction (grade 2+) and 2-digit × 1-digit multiplication (grade 3+).
