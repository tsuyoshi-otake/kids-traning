...
- Math, Japanese, life/social/science, English, technology/home economics, moral education, information/integrated study, special activities, and keyboard practice are independent ordered learning lanes through junior-high grade 3. The registered school grade is normally a parent-owned display and reporting attribute; the optional preference can use it only as the starting frontier, never as a question-selection cap. Completing difficulty 5 starts retention and automatically unlocks the next unit, including units above the registered grade; children cannot skip units manually.
