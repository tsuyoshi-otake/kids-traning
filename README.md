...
The fixed grade-1 and grade-2 kanji drills keep their 200-question courses and let the learner choose the direction before starting: select the correct reading for a shown kanji, or select the correct kanji spelling (including okurigana) for a shown reading. Each question labels whether it asks about an 音読み or a 訓読み. The four choices contain exactly one correct answer and use the same canonical MEXT kanji bank as the rest of the Japanese curriculum.
